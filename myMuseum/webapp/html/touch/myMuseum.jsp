...
<script type="text/javascript">
	...
	function fnloadClick(mthd){
		...
		var uri = "<%=request.getContextPath()%>/mm/2/msg/" + userId + "/" + pageIndex + "/MyMuseumMsg.json";
			...
			if(xhr.readyState == 4 && xhr.status == 200){
				...
				for(var i=0; i < obj.length; i++) {
					...
					document.getElementById("msg").innerHTML += 
                        ...
                        obj[i].userId + "</td><td align='right' class='td_info'>" + 
                        fnDay(obj[i].regDt) + "</td></tr></table>" +                        
...
/* 		container.setParam("msgId", msgId);
		container.setParam("userId", userId);
		location = /mmm/html/touch/viewMuseum.html; */
/* 		var uri = "/mmm/mm/1/msg/" + userId + "/" + msgId + "/message.json";
		alert(uri);
		location.method = "GET";
		location = uri;	 */			
