...
<script type="text/javascript">
	window.onload = function(){	
		...
		var topImgE = document.getElementById("topImg");
		if(screenWidth > 450) {
			topImgE.src = "/img/top_img.jpg";
		}
...
<body leftmargin='0' topmargin='0' bgcolor='#c4e1ff'>
<div id="content">
<table width='100%'  cellpadding='0' cellspacing='2'>
<tr><td bgcolor='white'>
<table width='100%'>
<tr>
	<td><img id='topImg' src='<%=request.getContextPath()%>/img/tops_img.jpg' width='100%'></td>
</tr>
</table>
<table width='100%'>
<tr>
