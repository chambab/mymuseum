		...
		for(var i=0; i < data.museum.length; i++) {
			...
			if(data.museum[i].seCode == '002') {							
				museumContent += "ⓜ <a href='javascript:fnSearch(\"" + data.museum[i].userId + "\")'>" + 
				                 ...
				                 "</td><td height='23' class='td_info_main'>" + data.museum[i].userNm + "</td></tr><tr><td height='23' class='td_info_main'>";
			} else {
...
<tr>
	...
	<tr>
	<td align='left' width='140'><img src='<%=request.getContextPath()%>/img/mymuseum100.png' width='130'></td>
